...
export default function Footer({ innerRef }) {
  return (
    <footer className="footer" ref={innerRef}>
      <div className="footer__top">
        <div className="footer__left">
          <p>Магазин уличной одежды</p>
          <p>690091, г. Владивосток, ул. Светланская, д. 83</p>
          <p>+7 (423) 200-45-12, designgang@mail.ru</p>
        </div>
        <div className="footer__right">
          <h4>Мы в соцсетях</h4>
          <div className="footer__socials">
            <a href="https://t.me/" className="social" target="_blank" rel="noreferrer">
            ...
            <a href="https://vk.com/" className="social" target="_blank" rel="noreferrer">
            ...
            <a href="https://nzelgram.ru/" className="social" target="_blank" rel="noreferrer">
      ...
      <div className="footer__pressure">
        <TextPressure
          text="DESIGN GANG"
          textColor="#fff"
          weight={true}
